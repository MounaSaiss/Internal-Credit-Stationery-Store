...
.card { border:none; border-radius:12px; box-shadow:0 3px 10px rgba(0,0,0,.05); }
.book-img { width:50px; height:70px; object-fit:cover; }
</style>
...
<div class="text-white fs-3 p-4 mt-3 text-center rounded"
