...
<body class="antialiased bg-gray-50 text-gray-800 font-figtree min-h-screen">
                    ...
                    <div>
                        ...
                        <select id="department" name="department"
                            ...
                            <option value="Frontend Dev"
                                {{ Auth::user()->department === 'Frontend Dev' ? 'selected' : '' }}>Frontend Dev
                            </option>
                            <option value="Backend Dev" {{ Auth::user()->department === 'Backend Dev' ? 'selected' : '' }}>
                                Backend Dev</option>
                            <option value="Full-Stack Dev"
                                {{ Auth::user()->department === 'Full-Stack Dev' ? 'selected' : '' }}>Full-Stack Dev
                            </option>
                            <option value="Marketing"
                                {{ Auth::user()->department === 'Marketing' ? 'selected' : '' }}>Marketing</option>
                            <option value="UI/UX Design (Figma)"
                                {{ Auth::user()->department === 'UI/UX Design (Figma)' ? 'selected' : '' }}>UI/UX
                                Design (Figma)</option>
                        </select>
                    </div>
    ...
    <div id="deleteModal" class="modal fixed inset-0 z-50">
        <div class="modal-backdrop fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
            <div
                class="modal-content bg-white rounded-xl shadow-2xl max-w-md w-full p-6 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div class="flex items-center gap-3 mb-4">
                ...
                <p class="text-gray-600 mb-6">
                    Are you absolutely sure you want to delete your account? This action cannot be undone. All your
                    data,
